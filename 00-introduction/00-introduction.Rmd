...
.center[
  ![:scale 800px](https://raw.githack.com/uo-ec607/lectures/master/02-git/02-Git.html#15)
]
...
```{r, summ4}
starwars %>% group_by(species, gender) %>% summarise(across(where(is.numeric), mean, na.rm=TRUE)) %>% head(5)
```
