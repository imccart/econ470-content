...
There are 5 homework assignments in this class (one for each module). Details of the assignments are on our [class website](https://econ470s22.classes.ianmccarthyecon.com/). Each assignment will have 10 questions and will be worth 30 points total. Each question is worth 3 points, allocated as follows:
...
We do not have a final exam in this class. Instead, we have a final project that asks you to submit a 5-page policy brief. Please see the [class website](https://econ470s22.classes.ianmccarthyecon.com/) for more details. The policy brief is worth 90 points (36%) toward your final grade.
