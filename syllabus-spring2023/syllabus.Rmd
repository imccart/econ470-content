...
Due dates for each stage are listed below:
  ...
  - Homework 3: Initial date (3/15), revision date (3/20), final date (3/22)
...
### 1/11: Motivation and overview

### 1/16: Data and version control
...
### 1/18, 1/23: Hospital prices and HCRIS data
...
### 1/25, 1/30: Introduction to causal inference
...
### 2/1, 2/6: Selection on observables
...
### 3/27, 3/29: Quality ratings and insurance choice

## Module 4: Medicaid Expansion and Difference-in-Differences

### 4/3, 4/5: The ACA and Medicaid expansion
...
### 4/17: Medicaid Expansion and Uninsurance
