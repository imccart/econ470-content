...
---
# Review of IV and Homework 3 in R

Some coding pointers to keep in mind:

- Function for extracting top observations, `top_n` (negative values to look from the bottom up)
- Syntax for `ivreg`, part of `ivpack`
- Using `stargazer` for regression output

---
# Other points from weekly surveys

- Examples of IV in real life
  - Month of birth
  - Vietnam lottery
  - Medicaid lottery in Oregon
  
- Problem with compliers
- Is a non-complier just in the control group?