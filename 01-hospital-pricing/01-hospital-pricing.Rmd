...
- Inference/hypothesis testing with standard two-sample t-test
...
plot3 + annotate("text",x=mean.x0, y=-2, label=TeX(r"($E\[Y_{1}\])"), size=5, parse=TRUE) +
  annotate("text", x=mean.x1, y=-2, label=TeX(r"($E\[Y_{0}\])"), size=5, parse=TRUE)
```
...
- How can we "remove" the bias term?
...
plot5 + annotate("text",x=mean.x0, y=mean.blue, label=TeX(r"($E\[Y_{1} | c\])"), size=4) +
  annotate("text", x=mean.x1, y=mean.blue, label=TeX(r"($E\[Y_{0} | c\])"), size=4) +
  annotate("text",x=mean.x0, y=mean.yellow, label=TeX(r"($E\[Y_{1} | s\])"), size=4) +
  annotate("text",x=mean.x1, y=mean.yellow, label=TeX(r"($E\[Y_{0} | s\])"), size=4) +
  annotate("text",x=mean.x0, y=mean.red, label=TeX(r"($E\[Y_{1} | t\])"), size=4) +
  annotate("text",x=mean.x1, y=mean.red, label=TeX(r"($E\[Y_{0} | t\])"), size=4)
```
...
x.end=mean.x1+.3
plot6 + annotate("text",x=mean.x0, y=mean.blue, label=TeX(r"($E\[Y_{1} | c\])"), size=4) +
  annotate("text", x=mean.x1, y=mean.blue, label=TeX(r"($E\[Y_{0} | c\])"), size=4) +
  annotate("text",x=mean.x0, y=mean.yellow, label=TeX(r"($E\[Y_{1} | s\])"), size=4) +
  annotate("text",x=mean.x1, y=mean.yellow, label=TeX(r"($E\[Y_{0} | s\])"), size=4) +
  annotate("text",x=mean.x0, y=mean.red, label=TeX(r"($E\[Y_{1} | t\])"), size=4) +
  ...
  annotate("text",x=x.end, y=mean.blue, label=TeX(r"($= E\[ Y_{1} - Y_{0} | c\])"), size=4) +
  annotate("text",x=x.end, y=mean.yellow, label=TeX(r"($= E\[ Y_{1} - Y_{0} | s\])"), size=4) +
  annotate("text",x=x.end, y=mean.red, label=TeX(r"($= E\[ Y_{1} - Y_{0} | t\])"), size=4)
```
...
plot6 + annotate("text",x=mean.x0, y=mean.blue, label=TeX(r"($E\[Y_{1} | c\])"), size=4) +
  ...
  annotate("text",x=x.end, y=ans.y, label=TeX(r"($ATE=E\[ Y_{1} - Y_{0} \])"), size=4)
```
...
1. Selection on observables: $$Y_{i}(1), Y_{i}(0) \perp\!\!\!\perp D_{i} | X_{i}$$
