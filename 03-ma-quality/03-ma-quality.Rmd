---
title: "Section 3: Medicare Advantage Quality and Regression Discontinuity"
...
est1 <- as.numeric(star25.3$coef[3])
est2 <- as.numeric(star25.1$coef[2])
```
...
---
# Interpretation
These estimates suggest a `r round(est1,3)*100`% increase in market shares among 2.5-star plans versus an "identical" 2-star plan, compared to an OLS estimate of `r round(est2,3)*100`%.
